            ...
            <div class="form">
              ...
              <div class="form-content">
                <div class="form-group">
                  ...
                  <input class="input" name="E-mail" type="email" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group2">
                  <input class="checkbox" read-only="{true}" type="checkbox" />

                  <div class="label2">Se souvenir de moi</div>
                </div>
